...
# PCA untuk menentukan n_components optimal (95% explained variance)
pca = PCA()
pca.fit(X_scaled)
...
# Terapkan PCA dengan n_components optimal
...
if df_results:
    ...
    df_summary.to_csv('result/hybrid_full_features_mean(smote).csv', index=False)
    print(df_summary)
else:
